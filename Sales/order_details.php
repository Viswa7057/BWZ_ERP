...
$uploadDirectory = 'PO/';
 ...
 $fileNamesStr = implode('|', $fileNames);
    ...
    $stmt_insert = "INSERT INTO order_details(created_date, company_name, contact_person_name, contact_person_mobile, email, Campaing_Details, Expected_Start_date, Any_Spl_Request, Media_Type, Total_No_of_Vehicles, Total_Value_Without_GST, PO, Checklist, sales_person, status, code) 
	  VALUES ('$date','$Company_Name','$Contact_Person_Name','$Contact_Person_Mob_No','$Email_ID','$Campaing_Details','$Start_date','$Spl_Request','$Media_Type','$No_of_Vehicles','$GST','$fileNamesStr','$file_name_checklist','$usename','NEW','$unique_id');";
...
$uploadDirectory = 'PO/';
    ...
    $txt_upload_dir_check = 'checklist/'; // Directory to store uploaded files
    ...
    <aside class="main-sidebar" style=" background: linear-gradient(327deg, #ff0000a3, #9cb3d7  ); color: #FFFFFF;">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          ...
          <li><a href="sales_dashboard.php " class="menu-link"><i class="fa fa-th-large " aria-hidden="true"></i> Dashboard</a></li><br><br>
...
<div class="modal fade" id="poModal" tabindex="-1" role="dialog" aria-labelledby="poModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="poModalLabel">Purchase Order Files</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body" id="poModalBody">
          <!-- PO files links will be added here -->
        </div>
    ...
    <input type="text" class="form-control" pattern="^[a-zA-Z0-9\s]*$" title="Please enter alphabet or number only" id="txt_Company_Name" name="txt_Company_Name" placeholder="Enter Company Name" required>
</div>
        ...
        <form action="upload_po.php" method="post" enctype="multipart/form-data">
            ...
            <button type="button" class="btn btn-primary" id="txt_addMoreBtn">Add PO</button>
                    ...
                    <table>
                      <tr>
                        ...
                        <th>
                          <div class="form-group" style="width:250px;">
                            <label for="UserID">Company Name<span style="color:red;">*</span></label>
                            <input type="text" class="form-control" pattern="^[a-zA-Z0-9\s]*$" title="Please enter alphabet only" id="Company_Name" name="Company_Name" placeholder="Enter Company Name" required>
                          </div>
                            <!--<div class="form-group" style="width:250px;">-->
                            <!--    <label for="UserID">Company Name<span style="color:red;">*</span></label>-->
                            <!--    <input type="text" class="form-control" pattern="^[a-zA-Z0-9\s]*$" title="Please enter alphabet or number only" id="Company_Name" name="Company_Name" placeholder="Enter Company Name" required>-->
                            <!-- </div>-->
        ...
        <form action="upload_po.php" method="post" enctype="multipart/form-data">
            ...
            <button type="button" class="btn btn-primary" id="addMoreBtn">Add PO</button>
           <!-- <button type="submit" class="btn btn-success">Upload</button> -->
        </form>
    </div>
                        </th>
  ...
  <script>
   ...
   <script>
   document.addEventListener('DOMContentLoaded', (event) => {
            const addMoreBtn = document.getElementById('txt_addMoreBtn');
            const additionalFields = document.getElementById('txt_additionalFields');
            let fileInputCount = 1;
            ...
            addMoreBtn.addEventListener('click', () => {
                if (fileInputCount < 5) {
                    ...
                    div.innerHTML = `
                        <label for="PO${fileInputCount}">PO(PDF) ${fileInputCount}</label>
                        <input type="file" class="form-control" id="PO${fileInputCount}" name="txt_PO[]">
                    `;
                    additionalFields.appendChild(div);
                } else {
                    alert('You can only add up to 5 files.');
...
//       if (!/^[a-zA-Z0-9\s]+$/.test(custName)) {
//     alert('Customer Name should contain only alphabets, numbers, and spaces.');
//     return false;
// }
