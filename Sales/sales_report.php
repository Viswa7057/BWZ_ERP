    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light" style="height:90px;">
      ...
      <ul class="navbar-nav">
        <li class="nav-item d-none d-sm-inline-block">
          <h2 style="margin-left:50px;color: #b52f34;"><b><i class="fa fa-align-center" aria-hidden="true"></i> Sales Report</b></h2>
        </li>
			...
			require_once("db_connect.php");
						   if (isset($_POST["btn_submit"]) == "btn_submit") {
							 ...
							 if($select_status=="New"){
								 $statusSQL ="status='NEW'";
							 }else if($select_status=="Rejected"){
								 $statusSQL ="HOD_Status='Rejected' AND ceo_status='Rejected'";
							 }else if($select_status=="Completed"){
								 $statusSQL ="HOD_Status='Accepted' AND ceo_status='Accepted'";
							}
///////////////////////////////////////////////////
							$stmt_login="SELECT * from order_details where $statusSQL AND sales_person='$usename' AND created_date >='$start_date 00:00:00' AND created_date <='$end_date 23:59:59' ORDER BY DATE(created_date) ASC;";
                       //   echo $stmt_login;
							  ...
							  while($row = mysqli_fetch_assoc($rslt_login)) {
											...
											<tr>
											  ...
											  <td class="col-xs-2" style="text-align: center;"><?php echo $row["company_name"]; ?></td>
											  
											  <td class="col-xs-2" style="text-align: center;"><?php echo $row["contact_person_name"]; ?></td>
											  <td class="col-xs-2" style="text-align: center;"><?php echo $row["contact_person_mobile"]; ?></td>
											  <td class="col-xs-2" style="text-align: center;"><?php echo $row["email"]; ?></td>
											  <td class="col-xs-2" style="text-align: center;"><?php echo $row["Campaing_Details"]; ?></td>
											  <td class="col-xs-2" style="text-align: center;"><?php echo $row["Expected_Start_date"]; ?></td>
											
											   <td class="col-xs-2" style="text-align: center;"><?php echo $row["Any_Spl_Request"]; ?></td>
											    <td class="col-xs-2" style="text-align: center;"><?php echo $row["Media_Type"]; ?></td>
												<td class="col-xs-2" style="text-align: center;"><?php echo $row["Total_No_of_Vehicles"]; ?></td>
												<td class="col-xs-2" style="text-align: center;"><?php echo $row["Total_Value_Without_GST"]; ?></td>
