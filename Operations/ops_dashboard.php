    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light" style="height:90px;">
      ...
      <ul class="navbar-nav">
        <li class="nav-item d-none d-sm-inline-block">
          <h2 style="margin-left:50px;color: #b52f34;"><b><i class="fa fa-th-large" aria-hidden="true"></i> Operations Dashboard</b></h2>
        </li>
      ...
      xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
         ...
         console.log(result1);
		  ...
		  $('#Completed_po').html(result[3]);
          $('#pending_po').html(result[4]);
		  
		  //DATA
          $('#CompletedSaleData').html(result[5]);
          $('#pendingSaleData').html(result[6]);
          $('#rejectedSaleData').html(result[7]);
		 
		  $('#Completed_PO_Data').html(result[8]);
          $('#pending_PO_Data').html(result[9]);
          ...
          var myChart = new Chart(ctx, {
            type: 'bar',
            data: {
              labels: ['Completed Payments', 'Pending Payments', 'Rejected Payments', 'Completed PO', 'Pending PO'],
              datasets: [{
                label: 'Data',
                data: [
