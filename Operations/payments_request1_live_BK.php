...
if ($_POST['addInfo_list']) {
 ...
 $comments= $_POST['txt_comments'];
  ...
  if ((!in_array($fileExtension_VD, $allowedFileTypes_VD)) && (!in_array($fileExtension_DC, $allowedFileTypes_DC)) && (!in_array($fileExtension_IN, $allowedFileTypes_IN))) {
    ...
    $stmt_update = "INSERT INTO payment_request(vendor_name, type_of_vendor, campaign_code, invoice, dc_report, vehicle_details, vehicle_images, Status, PI_invoice, ceo_update,total_prints,per_unit,OP_comments) VALUES ('$vendor_Name','$vendor_type','$Campaing_Code','$invoice','$file_name_DC','$file_name_VD','$zipFilePath','Requested','$file_name_IN','Please Upload The Voucher','$total_prints','$per_unit','$comments')";
                ...
                <tr>
                  ...
                  <th>
                    <div class="form-group">
                      <label for="IngroupName">Upload Vehical Details(Only PDF)</label>
                      <input type="file" class="form-control" accept=".pdf" id="vehicle_details" name="vehicle_details" required>
                    </div>
                  </th>
                  <th>
                    <div class="form-group">
                      <label for="IngroupName">Upload Vehical Images(Only ZIP)</label>
