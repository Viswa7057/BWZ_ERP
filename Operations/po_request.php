    ...
    <aside class="main-sidebar" style=" background: linear-gradient(327deg, #ff0000a3, #9cb3d7  ); color: #FFFFFF;">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          ...
          <li><a href="payments_request1.php" class="menu-link"><i class="fa fa-check-circle" aria-hidden="true"></i> Payments Request</a></li><br><br>
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            ...
                            <td>
                              <?php echo $row["acc_comments"] . "  " . $row["ceo_comments"] . "  " . $row["director_comments"]; ?>
                            </td>
                            <td>
                              <?php echo $row["status"]; ?>
                            </td>
