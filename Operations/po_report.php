    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light" style="height:90px;">
      ...
      <ul class="navbar-nav">
        <li class="nav-item d-none d-sm-inline-block">
          <h2 style="margin-left:50px;color: #b52f34;"><b><i class="fa fa-align-center" aria-hidden="true"></i> PO Report</b></h2>
        </li>
                      ...
                      <tbody>
                        ...
                        if (isset($_POST["btn_submit"]) == "btn_submit") {
                          ...
                          if ($start_date != "" && $end_date != "") {
                            ...
                            foreach ($_POST['status'] as $select_status) {
                              ...
                              ///////////////////////////////////////////////////
                              $stmt_login = "SELECT * from purchase where $statusSQL  AND date_time >='$start_date 00:00:00' AND date_time <='$end_date 23:59:59' ORDER BY DATE(date_time) ASC;";
                              //echo $stmt_login;
                        ...
                        ?>
                                <tr>
                                  ...
                                  <td class="col-xs-2" style="text-align: center;"><?php echo $row["total_prints"]; ?></td>
                                  <td class="col-xs-2" style="text-align: center;"><?php echo $row["per_unitcost"]; ?></td>
