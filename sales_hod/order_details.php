...
if ($_POST['accept_neworder']) {
  ...
  $stmt_update = "UPDATE order_details SET HOD_status='Accepted',status='CEO' WHERE id='$id'";
  ...
  $mail->Body = "<p>Dear $ops_user, </p> <h3>New Order Info has been added for Invoice, kindly check the dash board for more details.<br></h3>
...
if ($_POST['reject_neworder']) {
  ...
  $stmt_update = "UPDATE order_details SET HOD_status='Rejected',comments='$txt_reason' WHERE id='$txt_id'";
    ...
    <aside class="main-sidebar" style=" background: linear-gradient(327deg, #ff0000a3, #9cb3d7  ); color: #FFFFFF;">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          ...
          <li><a href="sales_report.php" class="menu-link"><i class="fa fa-align-center " aria-hidden="true"></i> Sales Report</a></li><br><br>
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            ...
                            <td>
                              <?php if ($row["HOD_Status"] == "Accepted" || $row["HOD_Status"] == "Rejected") { ?>
                              <?php } else { ?>
...
<script>
  ...
  <div id="popup" class="popup" style="display: none;margin-top: -1949px;margin-left: 985px;">
