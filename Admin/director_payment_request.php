...
if ($_POST['accept_ceo']){
  ...
  $stmt_update = "UPDATE payment_request SET Director_status='Accepted',Status='Payment Done',ceo_update='Voucher approved' WHERE id='$id'";
  ...
  $mail->setFrom('erp@brandonwheelz.com', 'Payment Confirmation');

  // Email content
  $mail->isHTML(true);

  $mail->Body = "<p>Dear all, </p> <h3> Payment Completed and voucher has been approved by Director, kindly check the dash board for more details<br></h3>
...
if($_POST['reject_order']) {
  ...
  $stmt_update = "UPDATE payment_request SET Status='Rejected', Director_status='Rejected',comments='$txt_reason' WHERE id='$txt_id'";
  ...
  $mail->Body = "<p>Dear $acc_user, </p> <h3>Your payment confirmation for voucher has been rejected by Director because of $txt_reason, kindly check the dash board for more details<br></h3>
...
if ($_POST['accept_ceo_internal']) {
  ...
  $stmt_update = "UPDATE internal_payment_request SET director_status='Accepted',status='Payment Done' WHERE id='$id'";
  ...
  $mail->Username = 'erp@brandonwheelz.com';
  $mail->Password = 'bytj wubr exys ggad';
  $mail->Subject = "Internal Payment Completed";
  $mail->setFrom('erp@brandonwheelz.com', 'Internal Payment Request');

  // Email content
  $mail->isHTML(true);

  $mail->Body = "<p>Dear all, </p> <h3>Internal Payment has been completed and approved by Director, kindly check the dashboard for more details<br></h3>
                     <br>Click the below link for login<br>
					 http://brandonwheelz.in/index.php<br>
                     <p></p>
                     <b></b>";
  ...
  $msg = "";
  $type = "success";
  $msg = "Internal Payment Accepted Successfully";
}
...
if ($_POST['reject_order_internal']) {
  ...
  $stmt_update = "UPDATE internal_payment_request SET status='Rejected',director_status='Rejected',director_comments='$txt_reason' WHERE id='$txt_id'";
  ...
  $mail->Body = "<p>Dear $acc_user, </p> <h3>Your internal payment confirmation for $order_name has been rejected by Director because $txt_reason, kindly check the dashboard for more details<br></h3>
                    Click the below link for login<br>
					http://brandonwheelz.in/index.php<br>
                     <p></p>
                     <b></b>";
  ...
  $msg = "";
  $type = "danger";
  $msg = "Internal Payment Rejected Successfully";
}
                      ...
                      <div class="card-body p-0">
                        <table class="table table-striped projects table-bordered" id="table_camp">
                          ...
                          <tbody>
                            ...
                            <?php
                            $stmt_select = "SELECT * from payment_request where ceo_status='Accepted' order by id desc";
                      ...
                      <div class="card-body p-0">
                        <table class="table table-striped projects table-bordered" id="table_internal">
                          ...
                          <tbody>
                            ...
                            <?php
                            $stmt_select_internal = "SELECT * from internal_payment_request where ceo_status='Accepted' order by id desc";
                            ...
                            ?>
                              <tr>
                                ...
                                <td>
                                  <?php echo $row_internal["ceo_comments"]; ?> <?php echo $row_internal["director_comments"]; ?>
                                </td>
                                ...
                                <td>
                                  ...
                                  <?php if ($row_internal["director_status"] == "" && $row_internal["ceo_status"] == "Accepted") { ?>
                                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
