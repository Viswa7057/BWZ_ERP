...
if ($_POST['addInfo_list']) {
  ...
  $stmt_update = "INSERT INTO purchase(vendor_name, Type_of_Vendor, campaign_code, total_prints, per_unitcost, Status,comments) VALUES ('$vendor_Name','$vendor_type','$Campaing_Code','$total_prints','$per_unit','Requested','$comments')";
  ...
  $msg = "PO Request Added Successfully";
  $type = "success";
}
...
if ($_POST['updateInfo_list']) {
  ...
  $txt_comments= $_POST['txt_comments'];
  
  $stmt_update = "UPDATE purchase SET vendor_name='$txt_vendor_Name',Type_of_Vendor='$txt_vendor_type',campaign_code='$txt_Campaing_Code',total_prints='$txt_total_prints',per_unitcost='$txt_per_unit',comments='$txt_comments' WHERE id='$txt_id'";

  $rslt_update = mysqli_query($conn, $stmt_update);
  
  $msg = "PO Request Updated Successfully";
  $type = "success";
}

if (isset($_POST['deleteIngroupID'])) {
    $deleteId = $_POST['deleteIngroupID'];
...
if ($_POST['accept_ceo']) {
  ...
  $stmt_update = "UPDATE purchase SET director_status='Accepted' WHERE id='$id'";
  ...
  $mail->Username = 'erp@brandonwheelz.com';
  $mail->Password = 'bytj wubr exys ggad';
  $mail->Subject = "PO Request For Vendor";
  $mail->setFrom('erp@brandonwheelz.com', 'PO Request For Vendor');

  $mail->isHTML(true);

  $mail->Body = "<p>Dear all, </p> <h3> PO Request For Vendor has been accepted by Director kindly check the dash board for more details<br></h3>
                     <br>Click the below link for login<br>
					 http://brandonwheelz.in/index.php<br>
                     <p></p>
                     <b></b>";
  $mail->addAddress("$ceo_email", "$ceo_name");
  ...
  $msg = "PO Request Accepted Successfully";
  $type = "success";
}
...
if ($_POST['reject_order']) {
  ...
  $stmt_update = "UPDATE purchase SET director_status='Rejected',director_comments='$txt_reason' WHERE id='$txt_id'";
  ...
  $mail->isHTML(true);
  $mail->Subject = "PO Request for Vendor";
  $mail->Body = "<p>Dear Team, </p> <h3>Your po request for new vendor has been rejected by Director because of $txt_reason, kindly check the dash board for more details<br></h3>
                    Click the below link for login<br>
					http://brandonwheelz.in/index.php<br>
                     <p></p>
                     <b></b>";
  ...
  $msg = "PO Request Rejected Successfully";
  $type = "danger";
}
?>
      ...
      <section class="content" style="background: linear-gradient(327deg, #ff0000a3, #FFFFFF), url('../images/bwz_erp_bg.jpg'); background-size: cover; background-position: center center;">
        <div class="container-fluid">
          ...
          <div class="card card-default">
            ...
            <div class="card-body">
<?php if (isset($msg)) { ?>
<div id="autoAlert" class="alert alert-<?php echo $type; ?> text-center">
    <?php echo $msg; ?>
</div>
<?php } ?>
                  ...
                  <div class="card-body p-0">
                    <table class="table table-striped projects table-bordered" id="table_camp">
                      ...
                      <tbody>
                        ...
                        <?php
                        $stmt_select = "SELECT * from purchase where status='Received' and acc_status='Accepted' and ceo_status='Accepted' order by id desc";
                        ...
                        ?>
                          <tr>
                            ...
                            <td>
                             <?php
echo ($row["created_date"] !== "0000-00-00 00:00:00")
    ? $row["created_date"]
    : "";
?>
                            ...
                            <td>
                             ...
                             <td>
                             <?php echo $row["ceo_comments"] . "  " . $row["director_comments"]; ?>
                            </td>
                            <td>
                              <?php echo $row["status"]; ?>
                            </td>
                            ...
                            <?php
                            if ($row["director_status"] == "") {
                            ?>
                              <button class="btn btn-success btn-sm" style="width: 91px;" onclick="acceptceo('<?php echo $row['id']; ?>','<?php echo $row['vendor_name']; ?>')">Accept</button>
                              <br><br>
                  ...
                  <table>
                    ...
                    <tr>
                      ...
                      <th>
                       ...
                       <th>
                                <div class="form-group" style="width:250px;">
                                    <label for="UserID">Comments<span style="color:red;">*</span></label>
                                    <textarea class="form-control" pattern="^[0-9\s]*$" title="Please enter Comments" id="txt_comments" name="txt_comments" placeholder="Enter Comments"></textarea>
                                </div>
                            </th>
 ...
 <th>
                                <div class="form-group" style="width:250px;">
                                    <label for="UserID">Comments<span style="color:red;">*</span></label>
                                    <textarea class="form-control" pattern="^[0-9\s]*$" title="Please enter Comments" id="comments" name="comments" placeholder="Enter Comments"></textarea>
                                </div>
                            </th>
                </tr>
          </div>
...
<div class="modal fade" id="myModal_accept" style="opacity: 3;top : 104px !important">
    <div class="modal-dialog">
      <div class="modal-content" style="top:40px;">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title">Accept PO Request</h4>
          ...
          <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="accept_vendor_name" name="accept_vendor_name" readonly>
              </div>
              <div class="form-group">
                <p>Are you sure you want to accept this PO request?</p>
              </div>
            </div>
            <input type="hidden" value="" id="ord_id" name="ord_id">
            <!-- /.card-body -->

            <div class="card-footer">
              <input type="submit" class="btn btn-success" name="accept_ceo" value="Accept">
            </div>
          </form>
        </div>
...
<div class="modal fade" id="myModal_ceo" style="opacity: 3;top : 104px !important">
    <div class="modal-dialog">
      <div class="modal-content" style="top:40px;">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title">Reject PO Request</h4>
          ...
          <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" id="order_reason" name="order_reason" placeholder="Enter reason for reject the PO request" required></textarea>
              </div>
            </div>
  ...
  <div class="modal fade" id="myModal_delete" style="opacity: 3;top : 104px !important">
    <div class="modal-dialog">
      <div class="modal-content" style="top:40px;">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title">Delete PO Request</h4>
        ...
        <div class="modal-body">
          <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
            <div class="card-body">
              ...
              <div class="form-group">
                <p>Are you sure you want to delete this PO request?</p>
              </div>
            </div>
            ...
            <div class="card-footer">
              <input type="submit" class="btn btn-danger" name="ingroupDeleteFun" value="Delete">
            </div>
          </form>
        </div>
  ...
  <script>
    ...
    function ingroupEditFun(val) {
      ...
      xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
          ...
          document.getElementById('txt_comments').value = res[6];
    ...
    function ingroupDeleteFun(val_id, cust_name) {
      //alert(cust_name);
    ...
    // Accept CEO function
    function acceptceo(ord_id, ord_name) {
      document.getElementById('ord_id').value = ord_id;
      document.getElementById('accept_vendor_name').value = ord_name;
      ...
      // Get the <span> element that closes the modal
      var span3 = document.getElementsByClassName("close25")[0];
