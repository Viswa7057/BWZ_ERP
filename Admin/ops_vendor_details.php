...
if ($_POST['accept_ceo']){
  ...
  $stmt_update = "UPDATE vendor_reg SET Director_status='Accepted',status='Director' WHERE id='$id'";
  ...
  $mail->Subject = "New Vendor Approved";
  // Sender and recipient details
  $mail->setFrom('erp@brandonwheelz.com', 'New Vendor Approved');

  // Email content
  $mail->isHTML(true);

  $mail->Body = "<p>Dear all, </p> <h3> New Vendor order has been approved by CEO kindly check the dash board for more details<br></h3>
...
if($_POST['reject_order']) {
  ...
  $stmt_update = "UPDATE vendor_reg SET Director_status='Rejected',comments='$txt_reason' WHERE id='$txt_id'";
  ...
  $mail->isHTML(true);
  $mail->Subject = "Payment Confirmation For New Vendor";
  $mail->Body = "<p>Dear $acc_user, </p> <h3>Your payment confirmation for new vendor has been rejected by CEO, kindly check the dash board for more details<br></h3>
                  ...
                  <div class="card-body p-0">
                    <table class="table table-striped projects table-bordered" id="table_camp">
                      ...
                      <tbody>
                        ...
                        <?php
                        $stmt_select = "SELECT * from vendor_reg;";
                        ...
                        ?>
                          <tr>
                            ...
                            <td>
                              ...
                              <button class="btn btn-primary" onclick="viewInvoice('<?php echo $VRF_file; ?>')"><i class="fa fa-eye"></i> VRF</button><br><br>-->
                              
                              <button class="btn btn-primary" onclick="viewCheck('<?php echo $cheq_file; ?>')"><i class="fa fa-eye"></i> Check</button><br><br>
                              
                              <button class="btn btn-primary" onclick="viewAggre('<?php echo $aggrement_file; ?>')"><i class="fa fa-eye"></i> Agreement</button><br><br>
