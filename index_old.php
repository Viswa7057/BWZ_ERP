...
if (isset($_POST["email"])) {
    ...
    if ($rowCount > 0) {
        ...
        if (!$mail->send()) {
            ...
            // Redirect user to OTP verification section
...
if (isset($_POST["verify"])) {
    if (!isset($_SESSION['otp'])) {
        // Redirect to the login page if there is no OTP in the session
    ...
    if ($otp != $otp_code) {
        ...
        $stmt_rs = "SELECT user_level from users where email='$email'";
    //   echo $stmt_rs; exit;
        ...
        if (count($row_rs) > 0) {
            ...
            $dashboard_urls = [
                'Admin' => 'https://brandonwheelz.in/Admin/admin_dashboard.php',
            ...
            if (array_key_exists($row_rs[0], $dashboard_urls)) {
                header('Location: ' . $dashboard_urls[$row_rs[0]]);
                exit();
            } else {
                                    ...
                                    <div class="card-body">
                                        <form action="#" method="POST" name="register">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" id="email_address" class="form-control" name="email" placeholder="Enter your email id" required>
                                                </div>
                                            </div>
