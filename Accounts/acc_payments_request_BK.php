                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            ...
                            <td>
                             <?php if ($row["voucher"] == "") { ?>
                                <button class="btn btn-success" style="width: 91px;background:red;border:1px solid red;" onclick="upload_voucher('<?php echo $row['id']; ?>','<?php echo $row['vendor_name']; ?>')">Upload Voucher</button>
                              <?php  } else {
                              } ?>
                            </td>
