...
if ($_POST['accept_neworder']) {
  ...
  $stmt_update = "UPDATE order_details SET ops_status='Accepted',status='Accounts' WHERE id='$id'";
  ...
  // After submit the form Send mail to RM
      ...
      $mail->Body = "<p>Dear $ops_user, </p> <h3>New Order Info has been added and requested for invoice. Kindly check the dash board for more details.<br></h3>
                     Click the below link for login<br>
					 https://brandonwheelz.in/index.php<br>
                     <p></p>
                     <b></b>";
...
if ($_POST['reject_neworder']) {
  ...
  $stmt_update = "UPDATE order_details SET ops_status='Rejected',comments='$txt_reason',status='NEW' WHERE id='$txt_id'";
  ...
  $mail->Body = "<p>Dear $loginUser, </p> <h3>Your new order has been rejected by Operations team. Kindly check the dash board for more details<br></h3>
                    Click the below link for login<br>
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light" style="height:90px;">
      ...
      <ul class="navbar-nav">
        <li class="nav-item d-none d-sm-inline-block">
          <h2 style="margin-left:50px;color: #b52f34;"><b><i class="fa fa-check-square" aria-hidden="true"></i> Sales Details</b></h2>
        </li>
      ...
      <section class="content" style="background: linear-gradient(327deg, #ff0000a3, #FFFFFF), url('../images/bwz_erp_bg.jpg'); background-size: cover; background-position: center center;">
        <div class="container-fluid">
          ...
          <div class="card card-default">
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            ...
                            <td>
                              <button class="btn btn-primary" onclick="viewCheck('<?php echo $Po_file; ?>')"><i class="fa fa-eye"></i> PO</button><br><br>
            ...
            <!-- btn -->
            <!-- Modal -->
            <div class="modal fade" id="myModal" style="opacity: 3;top : 104px !important; overflow-y:scroll;">
