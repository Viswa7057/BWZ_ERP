...
$targetFile_VD = basename($_FILES["invoice"]["name"]);
  ...
  $stmt_update = "UPDATE order_details SET PI_invoice='$file_name_VD',invoice_value='$invoice_value',acc_status='Accepted',status='CEO' WHERE id='$id'";
//echo $stmt_update; exit;
  ...
  // After submit the form Send mail to RM
	  ...
	  $stmt_sale = "SELECT email from users where user_name='$sales';";
  ...
  // After submit the form Send mail to RM
      ...
      $mail->isHTML(true);
      $mail->Subject = "$company_name - Invoice";
      $mail->Body = "<p>Dear $sales, </p> <h3>Kindly check the attached invoice doc for the $company_name.<br></h3>
                     Click the below link for login to see more details<br>
					 http://brandonwheelz.in/index.php<br>
                     <p></p>
                     <b></b>";
	  $filePath = "Invoice/" .$file_name_VD; // Replace with the path to your file
...
if ($_POST['reject_neworder']) {
  ...
  $stmt_update = "UPDATE order_details SET acc_status='Rejected',comments='$txt_reason' WHERE id='$txt_id'";
    ...
    <aside class="main-sidebar" style=" background: linear-gradient(327deg, #ff0000a3, #9cb3d7  ); color: #FFFFFF;">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          ...
          <li><a href="accounts_details.php" class="menu-link"><i class="fa fa-shopping-cart" aria-hidden="true"></i> New Sales Info</a></li><br><br>
		  <li><a href="accounts_vendor_details.php" class="menu-link"><i class="fa fa-shopping-cart" aria-hidden="true"></i> New Vendor Info</a></li><br><br>
          <li style="font-weight:bold;color: #ffff;">Reports</li><br><br>
          <li><a href="accounts_report.php" class="menu-link"><i class="fa fa-align-center " aria-hidden="true"></i> Operations</a></li><br><br>
    ...
    <div class="content-wrapper">
      ...
      <section class="content" style="background: linear-gradient(327deg, #ff0000a3, #FFFFFF), url('../images/bwz_erp_bg.jpg'); background-size: cover; background-position: center center;">
                  ...
                  <div class="card-body p-0">
                    <table class="table table-striped projects table-bordered" id="table_camp">
                      ...
                      <tbody>
                        ...
                        <?php
                        $stmt_select = "SELECT * from order_details where ops_status='Accepted' order by id desc;";
                        ...
                        while ($row = mysqli_fetch_assoc($rslt_rs)) {
						  ...
						  $PI_file = "Invoice/" . $row["PI_invoice"];
                        ...
                        ?>
                          <tr>
                            ...
                            <td>
                              <button class="btn btn-primary" onclick="togglePopup('<?php echo $Po_file; ?>','<?php echo $check_file; ?>')"><i class="fa fa-eye"></i> DOC</button><br><br>
                           ...
                           <td>
                                <?php if ($row["acc_status"] == "Accepted" || $row["acc_status"] == "Rejected") { ?>
                                <?php } else { ?>
                                 <button class="btn btn-success" style="width: 91px;" onclick="acceptInstallation('<?php echo $row['id']; ?>','<?php echo $row['company_name']; ?>','<?php echo $row['Media_Type']; ?>','<?php echo $row['sales_person']; ?>')">Accept</button>
                                <br>
                                  <br>
        ...
        <div class="modal fade" id="myModal_accept" style="opacity: 3;top : 104px !important">
            <div class="modal-dialog">
              <div class="modal-content" style="top:40px;height:600px;overflow-y:auto;">
                  ...
                  <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
                    <div class="card-body">
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        <label for="UserID">Media Type</label>
                        <input type="text" class="form-control" title="Please enter only characters" id="txt_type" name="txt_type" readonly>
                      </div>
					  
					  <div class="form-group">
                        <label for="UserID">Invoice Value<span style="color:red;">*</span></label>
                        <input type="text" class="form-control" title="Please enter only numbers" id="invoice_value" name="invoice_value" placeholder="Please Enter Invoice Value" required>
                      </div>
                    ...
                    <div class="card-footer">
                      <input type="submit" class="btn btn-success" name="accept_neworder" value="Accept">
                    </div>
                  </form>
                </div>
...
function acceptInstallation(Aval_id, Acust_name, type, sales) {
	  ...
	  document.getElementById('txt_salename').value = sales;
      // Get the modal
