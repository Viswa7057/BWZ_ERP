...
///////////////////////////////////////////////////
							$stmt_login="SELECT * from order_details where $statusSQL  AND created_date >='$start_date 00:00:00' AND created_date <='$end_date 23:59:59' ORDER BY DATE(created_date) ASC;";
                       //   echo $stmt_login;
