...
if ($_POST['accept_neworder']) {
  ...
  $stmt_update = "UPDATE vendor_reg SET ceo_status='Accepted',status='OPS' WHERE id='$id'";
...
$stmt_update = "UPDATE vendor_reg SET ceo_status='Rejected',status='Rejected' WHERE id='$txt_id'";
$rslt_update = mysqli_query($conn, $stmt_update); 
                        ...
                        ?>
                          <tr>
                            ...
                            <td>
                              ...
                              <button class="btn btn-primary" onclick="viewAggre('<?php echo $aggrement_file; ?>')"><i class="fa fa-eye"></i> Aggrement</button><br><br>
                              <button class="btn btn-primary" onclick="viewCheck('<?php echo $cheq_file; ?>')"><i class="fa fa-eye"></i> Cheque</button><br><br>
