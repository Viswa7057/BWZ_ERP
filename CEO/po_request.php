...
if ($_POST['accept_ceo']) {
  ...
  $stmt_update = "UPDATE purchase SET ceo_status='Accepted' WHERE id='$id'";
  ...
  $mail->Body = "<p>Dear all, </p> <h3> PO Request For Vendor has been requested by Op's team kindly check the dash board for more details<br></h3>
...
if ($_POST['reject_order']) {
  ...
  $stmt_update = "UPDATE purchase SET ceo_status='Rejected',ceo_comments='$txt_reason' WHERE id='$txt_id'";
  ...
  $mail->isHTML(true);
  $mail->Subject = "PO Request for Vendor";
  $mail->Body = "<p>Dear $acc_user, </p> <h3>Your po request for new vendor has been rejected by CEO, kindly check the dash board for more details<br></h3>
                    Click the below link for login<br>
					http://brandonwheelz.in/index.php<br>
                     <p></p>
                     <b></b>";
                  ...
                  <div class="card-body p-0">
                    <table class="table table-striped projects table-bordered" id="table_camp">
                      ...
                      <tbody>
                        ...
                        <?php
                        $stmt_select = "SELECT * from purchase where status='Received' order by id desc";
...
//             document.getElementById('vendor_Name').value = res[0];
//             $('#myModal_delete').modal('show');
//         }
//     };

//     // xhttp.open("GET", "deleteID.php", true);
//     // xhttp.send();
// }
