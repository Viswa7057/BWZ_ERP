...
<head>
  ...
  <style>
    ...
    .tile-image {
      max-width: 100%;
      /* Ensure image does not exceed tile width */
      max-height: 100%;
      /* Ensure image does not exceed tile height */
    }
    #totalRevenue {
      font-size: 24px; /* Increase this value to make the digits bigger */
      font-weight: bold;
    }
    #totalInvoice {
      font-size: 24px; /* Increase this value to make the digits bigger */
...
<body class="hold-transition sidebar-mini" id="sampleDiv_zoom">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light" style="height:90px;">
      ...
      <ul class="navbar-nav">
        <li class="nav-item d-none d-sm-inline-block">
          <h2 style="margin-left:50px;color: #b52f34;"><b><i class="fa fa-th-large" aria-hidden="true"></i> CEO Dashboard</b></h2>
        </li>
    ...
    <div class="content-wrapper">
      ...
      <section class="content" style="background: linear-gradient(327deg, #ff0000a3, #FFFFFF), url('../images/bwz_erp_bg.jpg'); background-size: cover; background-position: center center;">
        ...
        <div class="dashboard">
          ...
          <div class="tile" id="totalRevenueTile" data-toggle="modal" data-target="#myModal_totalRevenue">
            <h5 style="color:#e21717;"><b>Total Revenue</b></h5><br>
            <span><span id="totalRevenue" style="margin-left:20px;font-weight: bold;">0</span></span>
            <!-- <img class="totimg" src="images\totsales.jpg" alt="Total Revenue Image"> -->
          </div>
        ...
        <div class="dashboard">
          ...
          <div class="tile" id="totalInvoiceTile" data-toggle="modal" data-target="#myModal_totalInvoice">
            <h5 style="color:#e21717;"><b>Total Invoice Amount (Requested)</b></h5><br>
            <span style="margin-left:20px;font-weight: bold;"><span id="totalInvoice" style="margin-left:20px;">0</span></span>
            <!-- <img class="totinvoice" src="images\invoice.jpg" alt="Total Invoice Image"> -->
          </div>
        ...
        <div class="dashboard">
          ...
          <div class="tile" id="totalPaymentTile" data-toggle="modal" data-target="#myModal_totalPayment">
            <h5 style="color:#e21717;"><b>Total Payment Amount (Payment Done)</b></h5><br>
            <span style="margin-left:20px;font-weight: bold;"><span id="totalPayment" style="margin-left:20px;">0</span></span>
            <!-- <img class="totimg" src="images/payment.jpg" alt="Total Payment Image"> -->
          </div>
        </div>
  ...
  <script>
    function fetchTotalRevenue() {
        ...
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                var totalRevenue = this.responseText;
                document.getElementById('totalRevenue').innerHTML = totalRevenue;
            }
        };
        xhttp.open("GET", "get_total_revenue.php", true);
        xhttp.send();
    }

    function fetchTotalInvoice() {
        var xhttp = new XMLHttpRequest();
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                var totalInvoice = this.responseText;
                document.getElementById('totalInvoice').innerHTML = totalInvoice;
            }
        };
        xhttp.open("GET", "get_total_invoice.php", true);
        xhttp.send();
    }
    ...
    function fetchTotalPayment() {
        ...
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                var totalPayment = this.responseText;
                document.getElementById('totalPayment').innerHTML = totalPayment;
            }
        };
        xhttp.open("GET", "get_total_payment.php", true);
        xhttp.send();
    }

    // Call all functions initially and then set intervals for periodic updates
    fetchTotalRevenue();
    fetchTotalInvoice();
    fetchTotalPayment();
    setInterval(fetchTotalRevenue, 60000);
    setInterval(fetchTotalInvoice, 60000);
    setInterval(fetchTotalPayment, 60000);
</script>
