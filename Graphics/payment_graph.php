...
if ($_POST['accept_neworder']) {
  ...
  $stmt_update = "UPDATE payment_request SET graph_status='Accepted',status='Accounts' WHERE id='$id'";
...
$stmt_ops = "SELECT email,user_name from users where user_level='Accounts';";
  ...
  // After submit the form Send mail to RM
      ...
      $mail->isHTML(true);
      $mail->Subject = "Vendor Payment Request For Invoice";
      $mail->Body = "<p>Dear $ops_user, </p> <h3>Vendor Payment Request has been added and requested for Invoice. Kindly check the dash board for more details.<br></h3>
...
$stmt_update = "UPDATE payment_request SET graph_status='Rejected',comments='$txt_reason',status='Rejected' WHERE id='$txt_id'";
$rslt_update = mysqli_query($conn, $stmt_update); 
  ...
  $mail->isHTML(true);
  $mail->Subject = "Vendor Payment Request For Invoice";
  $mail->Body = "<p>Dear $txt_name team, </p> <h3>Your vendor Payment Request For Invoice has been rejected by Graphics team, because of $txt_reason. Kindly check the dash board for more details.<br></h3>
                     Click the below link for login<br>
					 http://brandonwheelz.in/index.php<br>
                     <p></p>
                     <b></b>";
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
         ...
         <li><a href="graph_dashboard.php" class="menu-link"><i class="fa fa-th-large " aria-hidden="true"></i> Dashboard</a></li><br><br>
		  <li><a href="payment_graph.php" class="menu-link"><i class="fa fa-check-circle" aria-hidden="true"></i> Payments Approval</a></li><br><br>
                          ...
                          <tr>
							...
							<td>
                                ...
                                <?php } else { ?>
                                  ...
                                  <br>
                                  <button class="btn btn-danger btn-sm" style="width: 91px;" onclick="rejectInstallation('<?php echo $row['id']; ?>','<?php echo $row['vendor_name']; ?>','<?php echo $row['campaign_code']; ?>')">Reject</button>
                                <?php
                                }
                                ?>
                              </td>
        ...
        <div class="modal fade" id="myuser" style="opacity: 3;top : 104px !important; overflow-y:scroll;">
          <div class="modal-dialog">
            <div class="modal-content" style="top:40px;width: 800px; margin-left: -100px;">
              ...
              <!-- Modal Header -->
              <div class="modal-header">
                <h4 class="modal-title">Add Vendor Payment Request</h4>
